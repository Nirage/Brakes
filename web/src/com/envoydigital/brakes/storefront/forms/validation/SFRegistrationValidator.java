 ...
 *
 */
@Component("brakesSFRegistrationValidator")
public class SFRegistrationValidator implements Validator
{


	Logger LOG = LoggerFactory.getLogger(SFRegistrationValidator.class);
