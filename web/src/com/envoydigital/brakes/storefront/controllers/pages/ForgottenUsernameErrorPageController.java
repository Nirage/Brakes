...
@Controller
@RequestMapping(value = "/forgot-username-error")
public class ForgottenUsernameErrorPageController extends AbstractPageController {
    ...
    {
        return getContentPageForLabelOrId("forgottenUsernameErrorPage");
    }
