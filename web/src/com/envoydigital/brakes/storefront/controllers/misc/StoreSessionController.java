...
import com.envoydigital.brakes.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
	...
	@ResponseBody
	@NoCache
	public Map<String, Object> getLoginStatus(final HttpServletResponse response)
	{
		...
		if(!userService.isAnonymousUser(currentCustomer)) {
			...
			result.put("loggedInStatus", true);
		}else {

			result.put("loggedInStatus", false);
		}
