...
public class AnalyticsPropertiesBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		String siteUid = baseSiteService.getCurrentBaseSite().getUid();
		final String serverName = request.getServerName();
		// Add config properties for google analytics
		addHostProperty(serverName, modelAndView, ThirdPartyConstants.Google.ANALYTICS_TRACKING_ID+"."+siteUid, ANALYTICS_TRACKING_ID+siteUid);
