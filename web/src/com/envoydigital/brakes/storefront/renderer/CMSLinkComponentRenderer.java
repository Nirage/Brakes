...
public class CMSLinkComponentRenderer implements CMSComponentRenderer<CMSLinkComponentModel>
{
			...
			IOException
	{
		try
		{
			...
			if(url != null) {
				renderComponent(pageContext, component, url);
			}
		}
	...
	private void renderComponent(final PageContext pageContext, final CMSLinkComponentModel component, String url) throws JspException, IOException {
