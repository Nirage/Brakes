    ...
    <li class="cart-item js-cartItem ${promoClass} ${(entry.promoGroupNumber gt -1  && viewPromotions) ? "js-cartItemPromoGroup" : ""}">
        ...
        <div class="cart-item__content">
            <div class="cart-item__image">
                <a href="${fn:escapeXml(productUrl)}"><components:productPicture product="${entry.product}" ttMobile="$basket-mobile$" ttTablet="$basket-tablet$" ttDesktop="$basket-desktop$" format="thumbnail"/></a>
            ...
            <div class="cart-item__details">
                <div class="cart-item__description">
                    <addoncart:cartItemDescription cartData="${cartData}" entry="${entry}" promo="${promo}" />
                </div>
