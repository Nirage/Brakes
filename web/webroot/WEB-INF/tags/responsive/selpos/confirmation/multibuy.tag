    ...
    <div class="order-sel__title  h-space-3">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-xs-4"><spring:theme code="orderSELsAndPOSSubmit.header.singleMultiPrice" /></div>
        ...
        <div class="order-sel____subHeading order-sel__bordered order-sel__para  h-space-3">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-4 order-sel__sectionText"><spring:theme code="orderSELsAndPOS.option.${product.multiPrice}"/></div>
                    <div class="col-xs-4 order-sel__sectionText">${product.singlePrice}</div>
                </div>  
            </div>
        </div>
    </c:forEach>
...
<div class="visible-xs">
    <c:forEach items="${order.products}" var="product">
        <div class="order-sel____subHeading order-sel__bordered order-sel__para  h-space-3">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-xs-4 order-sel__title"><spring:theme code="orderSELsAndPOSSubmit.header.singleMultiPrice" /></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4 order-sel__title"><spring:theme code="orderSELsAndPOSSubmit.header.rrp" /></div>
                    <div class="col-xs-2 order-sel____subHeading">${product.singlePrice}</div>
                </div>
            </div>                
         </div>
    </c:forEach> 
