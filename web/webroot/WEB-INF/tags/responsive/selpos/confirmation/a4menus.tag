...
<div class="hidden-xs">
    ...
    <c:if test="${not empty order.option.values}">
        <div class="order-sel____subHeading order-sel__bordered order-sel__para  h-space-3">
            <div class="row">
                  <div class="col-xs-12">
                      <div class="col-xs-4 order-sel__sectionText"><spring:theme code="orderSELsAndPOSSubmit.header.menuHolder" /></div>
                      <div class="col-xs-2 order-sel__sectionText"><spring:theme code="orderSELsAndPOSSubmit.header.menuHolder.value" /></div>
                  </div>
            </div>
        </div>
    </c:if>
