ACC.quote = {
  ...
  handleDiscountModal: function(options) {
    ...
    $(document)
      .find(options.actionButtonSelector)
      .click(function(e) {
        e.preventDefault();
    ...
    $(document)
      .find(options.cancelButtonSelector)
      .click(function(e) {
        e.preventDefault();
        ACC.colorbox.close();
      });
    ...
    function updateByPercentage() {
      ...
      var discountAmountVal = (total * percent) / 100;
      var discountAmount = discountAmountVal.toFixed(2);
      $("#js-quote-discount-by-amount").val(resetIntial(discountAmount));
      var remainTotalVal = total - discountAmount;
      var remainTotal = remainTotalVal.toFixed(2);
    ...
    function reset() {
      ...
      if (tot === "" || tot === 0.0) $("#js-quote-discount-adjust-total").val(total);
    }
    ...
    function holdPreviousValue(event) {
      ...
      if (text.indexOf(".") !== -1) {
        if (text.substring(text.indexOf(".")).length > 2 && (event.which !== 0 && event.which !== 8) && $(this)[0].selectionStart >= text.length - 2) {
          event.preventDefault();
        }
      }
    }
    ...
    function updateByAmount() {
      ...
      var percentVal = (discountAmount / total) * 100;
      var percent = percentVal.toFixed(2);
    ...
    function updateByAdjustTotal() {
      ...
      var discountAmountVal = total - adujstTotal;
      var discountAmount = discountAmountVal.toFixed(2);
      $("#js-quote-discount-by-amount").val(resetIntial(discountAmount));
      var percentVal = (discountAmount / total) * 100;
      var percent = percentVal.toFixed(2);
    ...
    function updateNewTotal(newTotal) {
      ...
      var newTotalParsed = parseFloat(newTotal)
        .toFixed(2)
        .replace(/(\d)(?=(\d{3})+\.)/g, "$1,"); // format num to money
      $("#js-quote-discount-new-total").text(currency.concat(newTotalParsed));
    }
  },
