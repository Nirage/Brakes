ACC.productorderform = {
  ...
  bindVariantSelect: function(variantSelectBtn, parentId) {
    variantSelectBtn.on("click", function(event) {
      ...
      var tableWrap = $(document)
        ...
        .clone()
        .empty()
        .attr("id", ACC.common.encodeHtml(parentId) + "Variant");
      ...
      var widthReference = $scrollContent.find(".widthReference").outerWidth(),
        heightReference =
          $scrollContent
            ...
            .eq(0)
            .height() / 2; // devided by 2 otherwise no nice behaviour
      var maxWidth = 0,
        maxHeight = 0;
      var widthDiff = 0,
        heightDiff = 0;
  ...
  orderGridScroll: function(scrollContent) {
    var showRight = false;
    var calcHeight = 0;
    var maxWidth = $(scrollContent)
      .find(".orderForm_grid_group")
      .innerWidth();
  ...
  calculateVariantTotal: function(_this, quantityToAdd) {
    ...
    var currentPrice = $(document)
      ...
      .val();
    var $gridTotalValue = $gridGroup.find("[data-grid-total-id=" + "total_value_" + currentIndex + "]");
    if (quantityToAdd > 0) $gridTotalValue.html(ACC.productorderform.formatTotalsCurrency(parseFloat(currentPrice) * parseInt(quantityToAdd)));
  }
};
