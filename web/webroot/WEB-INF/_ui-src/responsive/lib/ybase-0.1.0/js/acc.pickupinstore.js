ACC.pickupinstore = {
  ...
  createListItemHtml: function(data, id) {
    ...
    var $spanElStInfo = $("<span>")
      ...
      .append(
        $("<span>")
          .addClass("pickup-store-list-entry-city")
          .text(data.town)
      );
  ...
  pickupStorePager: function() {
    $(document).on("change", "#colorbox .js-pickup-store-input", function(e) {
      ...
      var checkedInput = $("#colorbox .pickup-store-list-entry input:checked");

      $("#add_to_cart_storepickup_form .js-store-id").attr("id", checkedInput.attr("id"));
      $("#add_to_cart_storepickup_form .js-store-id").attr("name", checkedInput.attr("name"));
      $("#add_to_cart_storepickup_form .js-store-id").val(checkedInput.val());
  ...
  checkIfPointOfServiceIsEmpty: function(cartEntryDeliveryModeForm) {
    return !cartEntryDeliveryModeForm
      .find(".pointOfServiceName")
      .text()
      .trim().length;
  },
