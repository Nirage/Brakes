...
<%-- VAT Display Text--%>
<c:set var="vatApplicableVisibilityClass" value="hide" />
<c:forEach items="${searchPageData.results}" var="product">
    <c:if test="${product.subjectToVAT}">
        <c:set var="vatApplicableVisibilityClass" value="" />
    </c:if>
</c:forEach>

<div class="js-vatApplicableMsg ${vatApplicableVisibilityClass}">
