...
<c:if test="${component.visible}">
    <div class="${navigationClass} js-${navigationClass} NAVcompONENT" data-title="${fn:escapeXml(component.navigationNode.title)}">
        <nav class="${navigationClass}__child-wrap">
