...
<div class="checkout-success mt2" data-order="${orderNumber}">
		...
		<div class="row">
			<div class="col-xs-12 flex align-items-center justify-content-center flex-direction-column p1">
				...
				<div class="text-center">
					<div class="font-primary-bold font-size-2 mt2 text-center"><spring:theme code='checkout.orderConfirmation.thankYouForOrder.oos' /></div>
				</div>
			</div>
		</div>
	</div>
