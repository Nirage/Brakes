...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/brakesstorefront/electronics/en",
						"https://electronics.local:9002/brakesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/brakesstorefront/electronics/en",
						"https://electronics.local:9002/brakesstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/brakesstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/brakesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/brakesstorefront/electronics/en",
						"https://electronics.local:9002/brakesstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/brakesstorefront",
						"https://electronics.local:9002/brakesstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/brakesstorefront",
						"https://electronics.local:9002/brakesstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/brakesstorefront/electronics/en",
						"https://electronics.local:9002/brakesstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
