...
public class AccountPageControllerTest
{
	...
	public void shouldGetAllOrders() throws CMSItemNotFoundException
	{
		...
		final String orderHistoryPage = accountController.orders(request, redirectModel, 1, showMode, "desc", null, page);
	...
	public void shouldNotGetNonExistingOrder() throws CMSItemNotFoundException
	{
		...
		final String orderHistoryPage = accountController.order(0, null, null, TEST_CODE, page, redirectModel);
	...
	public void shouldGetExistingOrder() throws CMSItemNotFoundException
	{
		...
		final String myAccountPage = accountController.order(0, null, null, TEST_CODE, page, redirectModel);
